        ...
        registerButton.setOnClickListener(view -> {
            ...
            if (fullName.isEmpty()) {
                ...
                if (databaseHelper.checkUserExists_Signup(email, mobile)) {
                    Toast.makeText(SignUpActivity.this, "Admin already exists!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (success) {
                        Notification notification = new NotificationCompat.Builder(SignUpActivity.this, CHANNEL_ID)
                                ...
                                .setContentText(fullName+" has Created a new Admin account")
                                ...
                                .setStyle(
                                        new NotificationCompat.BigPictureStyle()
                                                ...
                                                .setSummaryText(email+" has Created a new Admin account")
                                )
                                .build();
